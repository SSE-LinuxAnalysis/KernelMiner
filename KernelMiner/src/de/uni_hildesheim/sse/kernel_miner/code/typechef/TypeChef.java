...
public class TypeChef {
    ...
    static {
        try {
            Field f = Options.class.getDeclaredField("maxOptionId");
            f.setAccessible(true);
            f.set(null, new Character((char) 256));
     ...
     * Using this file helps reduce the complexity of the presence conditions, because
     * variables that are always true or always false can be filtered out. 
     * 
        ...
        Thread comm = new Thread("Comm of " + Thread.currentThread().getName()) {
            ...
            public void run() {
                try {
                    ...
                    file.setTokens((List<CToken>) in.readObject());
                    errors.addAll((List<String>) in.readObject());
